---
title: 'Local development and preview'
description: 'Install the Mintlify CLI to preview your documentation locally, catch broken links, and validate changes before pushing them to production.'
icon: 'terminal'
---
...
View a local preview of your documentation at `http://localhost:3000`.
...
Each CLI release ties to a specific version of Mintlify. If your local preview doesn't match the production version, update the CLI:
