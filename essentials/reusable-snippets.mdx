...
description: "Create reusable MDX snippets to share text, components, and variables across pages so you can update shared content from a single source file."
icon: "recycle"
---
