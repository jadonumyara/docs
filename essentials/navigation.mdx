---
title: 'Navigation'
description: 'Configure the navigation menu in docs.json to organize pages into groups, tabs, and anchors, and control sidebar order across your documentation.'
icon: 'map'
---
