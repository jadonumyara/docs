---
title: 'Site configuration with docs.json'
description: 'Customize your Mintlify site through the docs.json file, including theme, colors, logo, navigation, integrations, and global metadata defaults.'
icon: 'gear'
---
