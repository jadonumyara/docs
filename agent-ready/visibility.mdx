---
title: 'Content visibility for humans and AI agents'
description: 'Control which sections of your documentation are visible to human readers versus AI agents and crawlers using visibility settings in MDX.'
icon: 'eye'
---
